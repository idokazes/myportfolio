...
export default function Cards() {
    ...
    useEffect(() => {
        setLoader(true);
        fetch(`https://api.shipap.co.il/cards?token=d2960c7d-3431-11ee-b3e9-14dda9d4a5f0`)
            .then(res => res.json())
            .then(data => {
                setCards(data)
            })
    ...
    const adminRemoveCard = (id) => {
        ...
        setLoader(true);
        fetch(`https://api.shipap.co.il/admin/cards/${id}?token=d2960c7d-3431-11ee-b3e9-14dda9d4a5f0`, {
            credentials: 'include',
            method: 'DELETE',
        })
            .then(() => {
    ...
    const favorite = (id) => {
        fetch(`https://api.shipap.co.il/cards/${id}/favorite?token=d2960c7d-3431-11ee-b3e9-14dda9d4a5f0`, {
            credentials: 'include',
            method: 'PUT',
        })
            .then(() => {
    ...
    const unfavorite = (id) => {
        setLoader(true);
        fetch(`https://api.shipap.co.il/cards/${id}/unfavorite?token=d2960c7d-3431-11ee-b3e9-14dda9d4a5f0`, {
            credentials: 'include',
            method: 'PUT',
        })
            .then(() => {
    ...
    return (
        <div className='Cards'>
            <header>
                <h1>eazydate</h1>
                <p>למה לשבור את הראש? <br></br> כאן תראו את הבילויים שיהפכו כל יציאה שלכם לדייט המושלם</p>
            </header>
